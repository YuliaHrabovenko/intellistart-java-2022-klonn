...
CREATE TABLE interviewer_booking_limits (
	...
	CONSTRAINT interviewer_booking_limits_interviewer_id_fkey FOREIGN KEY (interviewer_id) REFERENCES public.users(id)
);
...
CREATE TABLE interviewer_time_slots (
	...
	CONSTRAINT interviewer_time_slots_interviewer_id_fkey FOREIGN KEY (interviewer_id) REFERENCES public.users(id)
);
...
CREATE TABLE bookings (
	...
	CONSTRAINT bookings_candidate_time_slot_id_fkey FOREIGN KEY (candidate_time_slot_id) REFERENCES public.candidate_time_slots(id),
	CONSTRAINT bookings_interviewer_time_slot_id_fkey FOREIGN KEY (interviewer_time_slot_id) REFERENCES public.interviewer_time_slots(id)
);
